...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-72 h-screen hidden md:flex flex-col bg-sidebar dark:bg-slate-950 border-r border-slate-200 dark:border-slate-800/80 z-50 transition-colors duration-300">
      {/* Brand Logo */}
      <div className="p-8">
